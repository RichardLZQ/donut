...
addlistener(handles.SliderGamma,'ContinuousValueChange',@(src,event) donut_dispslidermainfunc(hObject,handles));
...
% --- Executes on button press in MenuDisp.
function MenuDisp_Callback(hObject, eventdata, handles)
% hObject    handle to MenuDisp (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
donut_dispdrawfunc;
% Hint: get(hObject,'Value') returns toggle state of MenuDisp
...
% --- Executes on button press in ChckbxBgF.
function ChckbxBgF_Callback(hObject, eventdata, handles)
% hObject    handle to ChckbxBgF (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of ChckbxBgF
...
% --- Executes on button press in bttn_closeall.
function bttn_closeall_Callback(hObject, eventdata, handles)
% hObject    handle to bttn_closeall (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

global gh

handles.output = (gh.data.LblMaskI+gh.data.LblMaskM)>0;
guidata(hObject, handles);
uiresume(handles.figure1);


% --- Executes on button press in ChckbxAddLine.
function ChckbxAddLine_Callback(hObject, eventdata, handles)
% hObject    handle to ChckbxAddLine (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
donut_chckbxfunc(hObject);
% Hint: get(hObject,'Value') returns toggle state of ChckbxAddLine


% --- Executes on button press in ChckbxRemoveLine.
function ChckbxRemoveLine_Callback(hObject, eventdata, handles)
% hObject    handle to ChckbxRemoveLine (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
donut_chckbxfunc(hObject);
% Hint: get(hObject,'Value') returns toggle state of ChckbxRemoveLine


% --- Executes on button press in ChckbxLineStart.
function ChckbxLineStart_Callback(hObject, eventdata, handles)
% hObject    handle to ChckbxLineStart (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of ChckbxLineStart


% --- Executes on button press in ChckbxLineEnd.
function ChckbxLineEnd_Callback(hObject, eventdata, handles)
% hObject    handle to ChckbxLineEnd (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of ChckbxLineEnd


% --- Executes on button press in ChckbxDispLine.
function ChckbxDispLine_Callback(hObject, eventdata, handles)
% hObject    handle to ChckbxDispLine (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
