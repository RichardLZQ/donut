...
if strcmp(gh.param.ClickType,'alt')
    ...
    if get(gh.disp.ChckbxRemoveMask,'Value')...
        ...
        if DMin<gh.param.HlfWid
            ...
            elseif get(gh.disp.ChckbxPlotDF,'Value')
                ...
                ylim([min(gh.data.RawF(IdxMin,:)),max(gh.data.RawF(IdxMin,:))]);
                xlabel('Frame');
    ...
    elseif get(gh.disp.ChckbxErase,'Value')
        donut_erasefunc;
    elseif get(gh.disp.ChckbxAddLine,'Value')
        donut_addlinefunc(gh.param.CursorP);
    elseif get(gh.disp.ChckbxRemoveLine,'Value')
        donut_removelinefunc(gh.param.CursorP);
    end
end