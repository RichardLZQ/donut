...
for ii=1:size(IdxList,2)
    ...
    if gh.data.MaskType(IdxList(1,ii))==1
        ...
        OverlapMask=((gh.data.MaskPatchFin{1,IdxList(1,ii)}.*imfill(gh.data.LblMaskI(xL:xR,yL:yR)))==0);
        ...
        gh.data.MaskPatchFin{1,IdxList(1,ii)}=MaskDil;
        OverlapMask=((gh.data.MaskPatchFin{1,IdxList(1,ii)}.*imfill(gh.data.LblMaskM(xL:xR,yL:yR)))==0);
