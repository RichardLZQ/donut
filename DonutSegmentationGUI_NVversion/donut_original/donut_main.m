...
% Last Modified by GUIDE v2.5 22-Jun-2017 17:18:03
...
function EditHlfWid_Callback(hObject, eventdata, handles)
% hObject    handle to EditHlfWid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
donut_editfunc(hObject);
% Hints: get(hObject,'String') returns contents of EditHlfWid as text
%        str2double(get(hObject,'String')) returns contents of EditHlfWid as a double


% --- Executes during object creation, after setting all properties.
function EditHlfWid_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EditHlfWid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function SliderHlfWid_Callback(hObject, eventdata, handles)
% hObject    handle to SliderHlfWid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
donut_sliderfunc(hObject);
% Hints: get(hObject,'Value') returns position of slider
...
% --- Executes during object creation, after setting all properties.
function SliderHlfWid_CreateFcn(hObject, eventdata, handles)
% hObject    handle to SliderHlfWid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function SliderSensitivity_Callback(hObject, eventdata, handles)
% hObject    handle to SliderSensitivity (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
donut_sliderfunc(hObject);
% Hints: get(hObject,'Value') returns position of slider
...
% --- Executes during object creation, after setting all properties.
function SliderSensitivity_CreateFcn(hObject, eventdata, handles)
% hObject    handle to SliderSensitivity (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function EditExcludeEdgeNum_Callback(hObject, eventdata, handles)
% hObject    handle to EditExcludeEdgeNum (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
donut_editfunc(hObject);
% Hints: get(hObject,'String') returns contents of EditExcludeEdgeNum as text
%        str2double(get(hObject,'String')) returns contents of EditExcludeEdgeNum as a double


% --- Executes during object creation, after setting all properties.
function EditExcludeEdgeNum_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EditExcludeEdgeNum (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function SliderExcludeEdgeNum_Callback(hObject, eventdata, handles)
% hObject    handle to SliderExcludeEdgeNum (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
donut_sliderfunc(hObject);
% Hints: get(hObject,'Value') returns position of slider
...
% --- Executes during object creation, after setting all properties.
function SliderExcludeEdgeNum_CreateFcn(hObject, eventdata, handles)
% hObject    handle to SliderExcludeEdgeNum (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in ChckbxExcludeEdge.
function ChckbxExcludeEdge_Callback(hObject, eventdata, handles)
% hObject    handle to ChckbxExcludeEdge (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of ChckbxExcludeEdge


% --- Executes on button press in Chckbx_TransOnly.
function Chckbx_TransOnly_Callback(hObject, eventdata, handles)
% hObject    handle to Chckbx_TransOnly (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Chckbx_TransOnly


% --- Executes on selection change in loadtype.
function loadtype_Callback(hObject, eventdata, handles)
% hObject    handle to loadtype (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns loadtype contents as cell array
%        contents{get(hObject,'Value')} returns selected item from loadtype


% --- Executes during object creation, after setting all properties.
function loadtype_CreateFcn(hObject, eventdata, handles)
% hObject    handle to loadtype (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in pop_loadtype.
function pop_loadtype_Callback(hObject, eventdata, handles)
% hObject    handle to pop_loadtype (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns pop_loadtype contents as cell array
%        contents{get(hObject,'Value')} returns selected item from pop_loadtype


% --- Executes during object creation, after setting all properties.
function pop_loadtype_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pop_loadtype (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
