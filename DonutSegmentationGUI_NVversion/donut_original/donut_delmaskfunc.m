...
gh.data.InitLblMask(gh.data.InitLblMask==IdxMin)=0;
gh.data.InitLblMask(gh.data.InitLblMask>IdxMin)=gh.data.InitLblMask(gh.data.InitLblMask>IdxMin)-1;
...
if ICMFlag
    ...
    gh.data.Wm=CellRemoveEmpty(gh.data.Wm,IdxMin);
